...
import { NavLinks } from "@/app/assets/NavLinks";
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-60 lg:hidden w-12 h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-lg"
      >
